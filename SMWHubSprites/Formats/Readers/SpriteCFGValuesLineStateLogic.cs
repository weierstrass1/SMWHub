...
public partial class SpriteCFGReader
{
    private class SpriteCFGValuesLineStateLogic<TValue>(string lineName, char separator, TValue minLimit, TValue maxLimit, params (string, string)[] variables) : IStateBehaviourEnter where TValue : INumber<TValue>
    {
