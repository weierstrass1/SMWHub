...
{
    private class SpriteCFGParsingContext : ParsingContext
    {
        private readonly SpriteCFGReaderStateMachine _stateMachine;
        public SpriteCFGParsingContext(FileEnumeratorLineContext context) : base(context)
        {
