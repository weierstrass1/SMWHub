...
public static partial class SpriteCFGReader
{
    ...
    private partial class SpriteCFGReaderStateMachine : StateMachine<NSCFGStateEnum>
    {
        public SpriteCFGReaderStateMachine(StateData stateData) : base(stateData, NSCFGStateEnum.Type, configTransitions(), configStates(), new EmptyStateBehaviour())
        {
        ...
        private static Dictionary<NSCFGStateEnum, StateIDBehaviourPair<NSCFGStateEnum>> configStates()
        {
            ...
            states.Add(NSCFGStateEnum.Type, (NSCFGStateEnum.Type, new SpriteCFGValuesLineStateLogic<int>(
                "Sprite Type Line", ' ', 0, 2, ("Type", "Sprite Type"))));
            states.Add(NSCFGStateEnum.ActLike, (NSCFGStateEnum.ActLike, new SpriteCFGValuesLineStateLogic<byte>(
                "Act Like Line", ' ', 0, 255, ("ActLike", "Act Like"))));
            states.Add(NSCFGStateEnum.Tweaks, (NSCFGStateEnum.Tweaks, new SpriteCFGValuesLineStateLogic<byte>(
                "Tweakers Line", ' ', 0, 255,
                ("$1656", "Tweak 1656"),
                ("$1662", "Tweak 1662"),
                ("$166E", "Tweak 166E"),
                ...
                ("$1686", "Tweak 1686"),
                ("$190F", "Tweak 190F"))));
            states.Add(NSCFGStateEnum.Props, (NSCFGStateEnum.Props, new SpriteCFGValuesLineStateLogic<byte>(
            ...
            states.Add(NSCFGStateEnum.ExBytes, (NSCFGStateEnum.ExBytes, new SpriteCFGValuesLineStateLogic<int>(
