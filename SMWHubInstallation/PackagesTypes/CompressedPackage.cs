...
namespace SMWHubInstallation.Packages
{
    public partial class CompressedPackage(string packagePath, CodeScope scope) : IPackage
    {
        public const string DECOMPRESSED_DIRECTORY = "Decompressed";
        ...
        private void buildFolderPackage()
        {
            ...
            _folderPackage = new(destination, scope);
        }
        public long GetSize()
        {
